...
if ($_SESSION['position'] == '3') {
	...
	echo json_encode($cloud_users);
	foreach ($cloud_users['data'] as $cuser) {
	...
	if ($has_ba) { // if his/her BA is exists
?>
			<div class="row">
				<div class="col-xs-12 text-center">
				You don't have access to this page. Please ask your branch admin to create a new submission for you.
				</div>
			</div>
<?php
